    ...
    argTypes: {
        name: {
            ...
            options: [
                ...
                'codepen',
                'jsfiddle',
                'life-bouy, life-buoy, life-ring, life-saver, support',
                'circle-o-notch',
                'ra, rebel, resistance',
                'empire, ge',
                'git-square',
                'git',
                'hacker-news, y-combinator-square, yc-square',
                'tencent-weibo',
                'qq',
                'wechat, weixin',
                'paper-plane, send',
                ...
                'opencart',
                'expeditedssl',
                'battery, battery-4, battery-full',
                ...
                'address-book-o',
                'address-card, vcard',
                'address-card-o, vcard-o',
                'user-circle',
                'user-circle-o',
                'user-o',
                'id-badge',
                'drivers-license, id-card',
                'drivers-license-o, id-card-o',
                'quora',
                'free-code-camp',
                'telegram',
                ...
                'times-rectangle-o, window-close-o',
                'bandcamp',
                'grav',
                'etsy',
                'imdb',
